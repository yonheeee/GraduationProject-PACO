          ...
          <div className="first-content">
            ...
            <div className="first-bottom">
              ...
              <div className="first-social-icons">
                <img onClick={() => window.location.href = "http://localhost:8080/oauth2/authorization/kakao"}
                     src={kakaoIcon} alt="Kakao" className="first-icon-image"/>
                <img onClick={() => window.location.href = "http://localhost:8080/oauth2/authorization/naver"}
                     src={naverIcon} alt="Naver" className="first-icon-image"/>
                <img onClick={() => window.location.href = "http://localhost:8080/oauth2/authorization/google"}
                     src={googleIcon} alt="Google" className="first-icon-image"/>
              </div>
            </div>
          </div>
